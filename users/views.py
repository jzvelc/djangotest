...
from .serializers import UserSerializer, LoginSerializer, RefreshTokenSerializer, SessionLoginSerializer
...
class TokenLoginView(CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            r.publish('ps:public', json.dumps(message))
